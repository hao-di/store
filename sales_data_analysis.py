...
total=253.6*10+86.3*60+96.8*43+135.9*63+65.8*63+49.3*120+86.3*72+253.6*69+86.3*35+253.6*140+86.3*90+135.9*24+\
      65.8*45+96.8*25+86.3*60+65.8*129+253.6*10+96.8*43+65.8*63+86.3*60+135.9*63+96.8*60+65.8*58+86.3*140+\
       65.8*48+96.8*43+135.9*57+253.6+10+65.8*63+96.8*78
print("总销售额为：",round(total,2))
avg=(10+60+43+63+63+120+72+69+35+140+90+24+45+25+60+129+10+43+63+60+63+60+58+140+48+43+57+10+63+78)/30
print("平均每日销售数量为：",round(avg))
num=10+60+43+63+63+120+72+69+35+140+90+24+45+25+60+129+10+43+63+60+63+60+58+140+48+43+57+10+63+78
p1=(10+69+140+10+10)/num
print("羽绒服月销售量占比为：",round(p1,2))
p2=(63+24+63+57)/num
print("皮草月销售量占比为：",round(p2,2))
p3=(60+72+35+90+60+60+140)/num
print("牛仔裤月销售量占比为：",round(p3,2))
p4=(43+25+43+60+43+78)/num
print("风衣月销售量占比为：",round(p4,2))
p5=120/num
print("衬衫月销售量占比为：",round(p5,2))
p6=(63+45+129+63+58+48+63)/num
print("T恤月销售量占比为：",round(p6,2))
