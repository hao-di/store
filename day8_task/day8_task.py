...
#         num.append(sheet.cell_value(m,4))
#     for j in range(1,rows):
...
#                 dic[k] += sheet.cell_value(j,4)
#                 # print(dic[k])
# print(dic)
# for keys in dic:
#     print("%s的年销售占比为：%f"%(keys,dic[keys]/sum(num)))
'''每件衣服的月销售占比 (全年)'''
# ls=[]
# dic={}
# num=[]
...
#     print(dic)
#     for keys in dic:
#         print("%s的%d月销售占比为：%f" % (keys, (i+1),dic[keys] / sum(num)))
#     ls.clear()
#     dic.clear()
#     s.clear()
'''每件衣服的销售额占比 (全年)'''
